...
struct Modular{
    ...
    constexpr Modular &operator/=(const Modular &rhs)&{x*=rhs.inv();return *this;}
    friend constexpr Modular operator+(const Modular &lhs,const Modular &rhs){return Modular(lhr)+=rhs;}
    friend constexpr Modular operator-(const Modular &lhs,const Modular &rhs){return Modular(lhr)-=rhs;}
    friend constexpr Modular operator*(const Modular &lhs,const Modular &rhs){return Modular(lhr)*=rhs;}
    friend constexpr Modular operator/(const Modular &lhs,const Modular &rhs){return Modular(lhr)/=rhs;}
